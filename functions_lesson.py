...
# Where is the function invocation? name of the function and parenthese
# What is the return value? 3

# TODO: What will the output of the following code be? Why? Explain step-by-step the output would be 'int'
# because the max function returns 3, and type of 3 is integer
type(max([1, 2, 3]))

# TODO: What will the output of the following code be? Why? the output would be function as max is the 
# function
type(max)
...
def is_weekend(string):
    string = str(string)
    if string.lower() == 'saturday' or string.lower() == 'sunday':
        return True
    else:
        return False
# TODO: test out your is_weekend function with various values.
is_weekend('saturday')
# TODO: Use your is_weekend function in combination with input() 
# and an if statement to prompt the user for a day of the week and tell them
#  whether or not it is a weekend.
 user_input = input('Please input a day of the week: ')
if is_weekend(user_input):
    r


# TODO: Create a function named nonzero. It should accept a number
#  and return true if the number is anythong other than zero, false otherwise.
# TODO: Use your nonzero function in combination with the built-in input function 
# and an if statement to prompt the user for a number and print a message displaying
#  whether or not the number is zero.
# TODO: Transfer the work you have done into a function named explain_nonzero. 
# Calling this function should prompt the user and display the message as before.
...
sayhello()
# TODO: call the say hello function and pass your name as a string argument 
